...
const navItems = [
  { to: "/government", label: "Dashboard" },
  { to: "/government/profile", label: "Profile" },
];
    ...
    <div className="min-h-screen flex bg-stone-50">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-stone-200 py-6 px-4 gap-2">
        ...
        >
          ...
          <span className="font-black text-stone-900 tracking-tight">Government</span>
        </div>
      ...
      >
        <div className="flex items-center justify-between px-3 mb-6">
          <div
            ...
            onClick={() => { navigate("/government"); close(); }}
          >
            <div className="w-8 h-8 rounded-full bg-brand-700 flex items-center justify-center">
              <span className="text-white text-xs font-bold">G</span>
            </div>
