...
export const rwandaSeasonNameSchema = z
  .string()
  .trim()
  .transform((value) => {
  ...
  .refine((value) => ["Season A", "Season B", "Season C"].includes(value), {
    message: "Season must be one of: Season A, Season B, Season C",
  });
...
export const createSeasonSchema = z.object({
  body: z
    ...
    .refine((data) => !!data.startDate === !!data.endDate, {
      message: "Provide both startDate and endDate, or omit both to use Rwanda defaults",
      path: ["endDate"],
    })
