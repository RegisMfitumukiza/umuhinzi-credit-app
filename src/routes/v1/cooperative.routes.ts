...
cooperativeRouter.patch(
  ...
  authenticate,
  requireAdmin,
  validate(updateCooperativeStatusSchema),
  updateCooperativeStatus
);
 ...
 *   patch:
 *     summary: Update cooperative member status
 *     description: ADMIN or the cooperative's manager approves, removes, or reopens a member record.
 *     tags: [Cooperative Members]
 *     security:
 *       - bearerAuth: []
 *     parameters:
