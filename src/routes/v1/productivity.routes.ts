...
/**
 * @swagger
 * /api/v1/yields/{id}/verification:
 *   patch:
 *     summary: Verify or reject a yield record
 *     description: Admins and cooperative managers verify harvests using field visit evidence or cooperative collection records.
 *     tags: [Yields]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Yield verification updated successfully
 */
yieldRouter.patch(
  "/:id/verification",
  authenticate,
