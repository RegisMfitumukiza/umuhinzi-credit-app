...
/**
 * @swagger
 * /api/v1/financial-summaries/{id}/recalculate:
 *   patch:
 *     summary: Recalculate financial summary
 *     description: Recomputes seasonal income, expenses, net profit, and cash-flow status from yield records, market prices, input costs, and farm expenses.
 *     tags: [Financial Summaries]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Financial summary recalculated successfully
 */
financialSummaryRouter.patch(
  "/:id/recalculate",
  authenticate,
